...
Bootstrap uses [QUnit](http://api.qunitjs.com/), a powerful, easy-to-use JavaScript unit test framework. Each plugin has a imageFile dedicated to its tests in `unit/<plugin-name>.js`.
...
1. Locate and open the imageFile dedicated to the plugin which you need to add tests to (`unit/<plugin-name>.js`).
